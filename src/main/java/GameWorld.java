 ...
 * <p>
 * <strong>initialize()</strong> - Initialize the game world.<br>
 * <strong>beginGameLoop()</strong> - Creates a JavaFX Timeline object containing the game life cycle.<br>
 * <strong>updateSprites()</strong> - Updates the sprite objects each period (per frame)<br>
 * <strong>checkCollisions()</strong> - Method will determine objects that collide with each other.<br>
